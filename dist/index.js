...
var W=require('@stdlib/blas-base-assert-is-layout/dist'),X=require('@stdlib/math-base-special-max/dist'),B=require('@stdlib/error-tools-fmtprodmsg/dist'),Y=F();function $(v,r,o,n,a,e,p,u){var y,s,l,i,q;if(!W(v))throw new TypeError(B('nullFx',v));if(v==="row-major"&&n<X(1,r))throw new RangeError(B('nullG4',r,n));if(u>0)s=1,q=a;else if(u<0)s=-1,q=a+(a-e)*u,y=a,a=e,e=y;else return o;return v==="column-major"?(l=1,i=n):(l=n,i=1),Y(r,o,l,i,0,a,e,s,p,u,q)}C.exports=$
